...
void PowerSupplyManager::setParamsForPwrSupply(out out, parametrRead pr, const double &value)
{
    ...
    if(m_powerSupplyIndex==0){
        ...
        if(m_outNumber == 1)emit paramsPowerChanged(PowerOuts::POW1_OUT1);
                else emit paramsPowerChanged(PowerOuts::POW1_OUT2);
    }
...
void PowerSupplyManager::sendUpdateSignal()
{
    ...
    if(m_powerSupplyIndex==1){
        ...
        if(m_outNumber == 1)emit paramsPowerChanged(PowerOuts::POW2_OUT1);
                else emit paramsPowerChanged(PowerOuts::POW2_OUT2);
    }
    if(m_powerSupplyIndex==2){

        if(m_outNumber == 1)emit paramsPowerChanged(PowerOuts::POW3_OUT1);
                else emit paramsPowerChanged(PowerOuts::POW3_OUT2);
    }
    if(m_powerSupplyIndex==3){

        if(m_outNumber == 1)emit paramsPowerChanged(PowerOuts::POW4_OUT1);
                else emit paramsPowerChanged(PowerOuts::POW4_OUT2);
    }
}
...
{
 if(m_powerSupplyIndex == 0){
     if(m_outNumber == 1)return PowerOuts::POW1_OUT1;
     else return PowerOuts::POW1_OUT2;
 };
 if(m_powerSupplyIndex == 1){
     if(m_outNumber == 1)return PowerOuts::POW2_OUT1;
     else return PowerOuts::POW2_OUT2;
 };
 if(m_powerSupplyIndex == 2){
     if(m_outNumber == 1)return PowerOuts::POW3_OUT1;
     else return PowerOuts::POW3_OUT2;
 };
 if(m_powerSupplyIndex == 3){
     if(m_outNumber == 1)return PowerOuts::POW4_OUT1;
     else return PowerOuts::POW4_OUT2;
 };
...
{
    if(m_powerSupplyIndex == 0){powerSupply_1.value("isConnected") = true;sendUpdateSignal();m_results.power1 = true;}
    if(m_powerSupplyIndex == 1){powerSupply_2.value("isConnected") = true;sendUpdateSignal();m_results.power2 = true;}
    if(m_powerSupplyIndex == 2){powerSupply_3.value("isConnected") = true;sendUpdateSignal();m_results.power3 = true;}
    if(m_powerSupplyIndex == 3){powerSupply_4.value("isConnected") = true;sendUpdateSignal();m_results.power4 = true;}
...
void PowerSupplyManager::disconnectedCase()
{
    ...
    if(m_powerSupplyIndex == 0){powerSupply_1.value("isConnected") = false;sendUpdateSignal();}
    if(m_powerSupplyIndex == 1){powerSupply_2.value("isConnected") = false;sendUpdateSignal();}
    if(m_powerSupplyIndex == 2){powerSupply_3.value("isConnected") = false;sendUpdateSignal();}
    if(m_powerSupplyIndex == 3){powerSupply_4.value("isConnected") = false;sendUpdateSignal();}
