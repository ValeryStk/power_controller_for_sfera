...
private:
    ...
    enum class out : uint8_t { out1, out2 };
    ...
    double m_acrcy_V;
    double m_check_I;
    double m_last_V_mult;  // Это множитель для последнего прибавления m_delta_V
                           // * m_last_V_mult
    bool m_isLastV;
...
signals:
    ...
    void allLampsSwitchedOff();
    void timeOutCaseWasHappened();
};
